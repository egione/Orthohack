...
*/
#define TABLE_LITERAL_DEFINED 1
/*
This readonly data structure is sufficiently overallocated to facilitate read-past-end for speed.

By the way, l stands for "literal_list_base". We need to abbreviate because the generated ortholiteral.c can be huge.
*/
const NUMBER l[NUMBER_COUNT+1]={LITERAL_LIST};
